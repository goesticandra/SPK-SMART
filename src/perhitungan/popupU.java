 ...
 * @author Gusti
 */
public class popupU extends javax.swing.JFrame {
private Connection conn = new koneksi().connect();
private DefaultTableModel tabmode;

public Utility puu = null;
    /**
    ...
    Object[] Baris ={"Nama","Status Pernikahan","Jumlah Tanggungan","Usia","Jenis Pekerjaan","Pendapatan"};
        ...
        try {
            String sql = "SELECT * FROM alternatif where nama like '%"+cariitem+"%' or status like'%"+cariitem+"%' order by nama asc";
    ...
    puu.nama = tblgaji.getValueAt(tabelGaji, 0).toString();
    puu.statusnikah = tblgaji.getValueAt(tabelGaji, 1).toString();
    puu.jumlahtanggungan = tblgaji.getValueAt(tabelGaji, 2).toString();
    puu.usia = tblgaji.getValueAt(tabelGaji, 3).toString();
    puu.jenispekerjaan = tblgaji.getValueAt(tabelGaji, 4).toString();
    puu.pendapatan = tblgaji.getValueAt(tabelGaji, 5).toString();
    puu.popupAlternatif();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popupU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
