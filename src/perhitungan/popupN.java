 ...
 * @author Gusti
 */
public class popupN extends javax.swing.JFrame {
private Connection conn = new koneksi().connect();
private DefaultTableModel tabmode;

public Hasil pun = null;
    /**
    ...
    Object[] Baris ={"Status Pernikahan","Jumlah Tanggungan","Usia","Jenis Pekerjaan","Pendapatan"};
        ...
        try {
            String sql = "SELECT * FROM kriterianormalisasi where statusnikah like '%"+cariitem+"%' or usia like'%"+cariitem+"%' order by statusnikah asc";
    ...
    pun.statusnikah = tblgaji.getValueAt(tabelGaji, 0).toString();
    pun.jumlahtanggungan = tblgaji.getValueAt(tabelGaji, 1).toString();
    pun.usia = tblgaji.getValueAt(tabelGaji, 2).toString();
    pun.jenispekerjaan = tblgaji.getValueAt(tabelGaji, 3).toString();
    pun.pendapatan = tblgaji.getValueAt(tabelGaji, 4).toString();
    pun.popupN();
