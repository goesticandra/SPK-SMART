...
public Normalisasi pub = null;
    ...
    Object[] Baris ={"Status Pernikahan","Jumlah Tanggungan","Usia","Jenis Pekerjaan","Pendapatan"};
        ...
        try {
            String sql = "SELECT * FROM kriteriabobot where statusnikah like '%"+cariitem+"%' or usia like'%"+cariitem+"%' order by statusnikah asc";
    ...
    pub.statusnikah = tblgaji.getValueAt(tabelGaji, 0).toString();
    pub.jumlahtanggungan = tblgaji.getValueAt(tabelGaji, 1).toString();
    pub.usia = tblgaji.getValueAt(tabelGaji, 2).toString();
    pub.jenispekerjaan = tblgaji.getValueAt(tabelGaji, 3).toString();
    pub.pendapatan = tblgaji.getValueAt(tabelGaji, 4).toString();
    pub.popupbobot();
